            ...
            {props.reposToShow.map(repo => (
                ...
                <div className="col " key={repo.id}>
                    <div className="card h-100 ">
                        {
                            repo.homepage === null ?
                                <a href={`https://victorcodrean.github.io/${repo.name}`} target="_blank" rel="noopener noreferrer">
                    ...
                    Deployed app</small>
                            ...
                            <a className="link-hover" href={repo.html_url} target="_blank" rel="noopener noreferrer" style={{ float: "right", textDecoration: "none" }}>
                                <small className="text-muted" style={{ fontSize: "15px" }}>
                                    <i className="fab fa-github" style={{ paddingRight: "8px" }}></i>
                    GitHub link</small>
                            </a>
                        </div>
                    </div>
